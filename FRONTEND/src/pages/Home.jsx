    ...
    <div style={styles.container}>
      ...
      {!confesWin ? (
        <div style={styles.centerBox}>
          ...
          <button style={styles.centerBtn} onClick={() => setConfesWin(true)}>
            Confess
          </button>
        </div>
      ) : (
        <div style={{ ...styles.centerBox, margin: "4rem 0" }}>
          ...
          />
          <button style={styles.confessBtn} onClick={handleConfess}>
            Submit
          </button>
          <p style={styles.p}>
            Back to{" "}
            <span style={styles.back} onClick={() => setConfesWin(false)}>
              Home
            </span>
          </p>
        </div>
